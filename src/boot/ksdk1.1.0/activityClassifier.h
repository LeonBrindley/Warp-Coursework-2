...
uint16_t numberOfInflectionPoints = 0; // The  number of local maxima and minima in the array. Use (float)(numberOfInflectionPoints / 2) instead of the number of steps to avoid rounding errors.
