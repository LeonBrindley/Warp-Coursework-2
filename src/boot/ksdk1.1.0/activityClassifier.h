...
#define SAMPLE_PERIOD 100 // Take a sample every 25ms (40 times per second) across all three cartesian axes.
...
uint16_t numberOfRunning = 0;
uint16_t numberOfWalking = 0;
uint16_t numberOfStationary = 0;
