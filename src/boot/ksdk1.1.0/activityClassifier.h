...
uint16_t numberOfSteps = 0; // Number of steps over the past 10 seconds. Initialised to 0. Susceptible to rounding errors, so use (float)(numberOfInflectionPoints / 2) if possible.
