...
WarpStatus updateAccelerations(){
  ...
  uint32_t XAcceleration, YAcceleration, ZAcceleration; // Actual acceleration values for checking their accuracy.
  ...
  XAcceleration = (uint32_t)XCombined * 4787; // Convert the acceleration to ums^-2.
  warpPrint("XMSB: %d.\n", XMSB);
  warpPrint("XLSB: %d.\n", XLSB);
  ...
  YAcceleration = (uint32_t)YCombined * 4787; // Convert the acceleration to ums^-2.
  // warpPrint("YMSB: %d.\n", YMSB);
  // warpPrint("YLSB: %d.\n", YLSB);
  ...
  ZAcceleration = (uint32_t)ZCombined * 4787; // Convert the acceleration to ums^-2.
  // warpPrint("ZMSB: %d.\n", ZMSB);
  // warpPrint("ZLSB: %d.\n", ZLSB);
  ...
  accelerationMagnitude = sqrtInt((XAcceleration*XAcceleration) + (YAcceleration*YAcceleration) + (ZAcceleration*ZAcceleration));
