...
WarpStatus updateAccelerations(){
  ...
  XAcceleration = (int32_t)((int32_t)XCombined * (float)4.787); // Convert the acceleration to mms^-2.
  warpPrint("XMSB: %d.\n", XMSB);
  warpPrint("XLSB: %d.\n", XLSB);
  ...
  YAcceleration = (int32_t)((int32_t)YCombined * (float)4.787); // Convert the acceleration to mms^-2.
  warpPrint("YMSB: %d.\n", YMSB);
  warpPrint("YLSB: %d.\n", YLSB);
  ...
  ZAcceleration = (int32_t)((int32_t)ZCombined * (float)4.787); // Convert the acceleration to mms^-2.
  warpPrint("ZMSB: %d.\n", ZMSB);
  warpPrint("ZLSB: %d.\n", ZLSB);
